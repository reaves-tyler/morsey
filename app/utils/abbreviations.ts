...
/**
 * Everyday shorthand that is not quizzed in the tiers but turns up in real
 * copy, so the decode terminal can still explain it on hover. Tier items take
 * precedence when both define an abbreviation.
 */
export const COMMON_ABBREVIATIONS: Record<string, string> = {
  OM: 'Old man — any male ham',
  YL: 'Young lady — a female ham',
  XYL: 'Wife',
  TKS: 'Thanks',
  TNX: 'Thanks',
  ...
  KY: 'Key',
  SS: 'Sweepstakes contest',
  TEST: 'Contest (CQ TEST)',
  '55': 'Best success',
  '99': 'Go away',
  NAME: 'Name',
  HRE: 'Here',
